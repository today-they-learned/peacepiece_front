...
const CrewData = [
  ...
  },
  {
    ...
    content:
      ...
      "API를 개발하며 요구사항을 어떠한 로직으로, 구조적으로 구현할 지 고민하며 클린한 코드를 짜고자 노력하였습니다." +
      "또한 구현한 기능을 테스트하며 예상하지 못한 오류를 발견하고 이를 해결하며 서비스를 개선하였습니다.\n\n" +
      "환경 문제가 심각한 요즘 환경 보호와 관련된 프로젝트를 진행할 수 있어 의미있었습니다." +
      "좋은 팀원들과 함께할 수 있어 협업하며 개발하는 과정이 즐거웠고, 개발 외적으로도 많이 배울 수 있는 시간이었습니다.",
  },
];
